...
class Pago extends CI_Controller
{
    ...
    public function getPagoReporte()
    {
        if (true) {
    ...
    public function insertPago()
    {
        if (true) {
            ...
            if (!empty($this->input->post('tipo_pago'))) {
                $request->id_tipo_pago = $this->security->xss_clean($this->input->post('tipo_pago'));
            } else {
